...
export default function SettingsScreen() {
  ...
  return (
    <KeyboardAvoidingView
      ...
      // 👇 No extra offset – lets content hug the keyboard like IG
        ...
        <View style={{ flex: 1 }}>
          <ScrollView
            ...
            contentContainerStyle={[
              ...
              {
                // 👇 Small padding when editing so gap is minimal
          ...
          >
            {/* Whole screen tappable background, just like job-detail */}
            <TouchableWithoutFeedback
